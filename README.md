...
**バージョン:** 0.2.0 | **ライセンス:** MIT | **対応OS:** Windows 10 / 11
...
│  LIVE スクショビュー    │  チャット                     │
│                         │                               │
│  [最新スクリーン        │  User: Chromeを開いてGitHub   │
│   ショット表示]         │        にアクセスして         │
│                         │                               │
│  動作中: LIVE バッジ    │  Agent: THINK: Chrome を起動  │
│                         │         する...               │
│  クリックで拡大         │                               │
│                         │  ───────────────────────────  │
│                         │  [メッセージを入力...] [送信] │
...
- macOS / Linux 対応
- 対応言語の追加（中国語・韓国語等）
- ローカル LLM（Ollama 等）対応
- タスクのスケジューリング・自動実行
- Web パネルでの `OPERANT.md` 編集 UI
